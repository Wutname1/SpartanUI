...
function module:SetupMenus()
	spartan.opt.args["Artwork"].args["backdrop"] = {
	...
	spartan.opt.args["Artwork"].args["popup"] = {
	...
	spartan.opt.args["Artwork"].args["offset"] = {name = L["ConfOffset"],type = "range",order = 3,width="double",
	...
	spartan.opt.args["Artwork"].args["offsetauto"] = {name = L["AutoOffset"],type = "toggle",order = 4,
