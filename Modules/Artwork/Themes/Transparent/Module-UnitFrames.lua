...
local base_plate1 = [[Interface\AddOns\SpartanUI_Artwork\Themes\Transparent\Images\base_plate1.tga]] -- Player and Target
...
local CreatePlayerFrame = function(self,unit)
	...
	do -- setup ring, icons, and text
		...
		self.Level:SetPoint("CENTER",ring,"CENTER",45,12);
...
SpartanoUF:RegisterStyle("Spartan_TransparentFrames", CreateUnitFrame);

function module:UnitFrames()
	local addon = spartan:GetModule("PlayerFrames");
	SpartanoUF:SetActiveStyle("Spartan_TransparentFrames");
