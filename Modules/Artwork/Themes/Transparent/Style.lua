...
function module:SetupMenus()
	spartan.opt.Artwork.args["backdrop"] = {
	...
	spartan.opt.Artwork.args["popup"] = {
...
function module:OnInitialize()
	if (DBMod.Artwork.Theme == "Transparent") then
		module:Init()
	else
		module:Disable();
	end
...
function module:OnEnable()
	if (DBMod.Artwork.Theme == "Transparent") then
		if (not InitRan) then Init(); Bartender4:UpdateModuleConfigs(); end
