...
function module:InitActionBars()
	do -- create bar plate and masks
		...
		plate.mask1 = CreateFrame('Frame', 'SUI_Popup1Mask', SUI_Art_Classic, 'SUI_Popup1MaskTemplate')
		plate.mask1:SetFrameStrata('MEDIUM')
		plate.mask1:SetFrameLevel(0)
		plate.mask1:SetPoint('BOTTOM', SUI_Popup1, 'BOTTOM')

		plate.mask2 = CreateFrame('Frame', 'SUI_Popup2Mask', SUI_Art_Classic, 'SUI_Popup2MaskTemplate')
