	...
	if(name) then
		...
		if(show) then
			...
			if UnitIsUnit('player', unit) then
				icon:SetScript("OnClick", function(self,index,unit)
					if not InCombatLockdown() then CancelUnitBuff('player', self:GetID()) else print("Sorry, you cannot do that in combat") end
				end)
			end
