...
LibsDisenchantAssist.DisenchantLogic = {}
local DisenchantLogic = LibsDisenchantAssist.DisenchantLogic
...
function DisenchantLogic:CanDisenchant()
    ...
    if not IsUsableSpell(self.DISENCHANT_SPELL_ID) then
...
function DisenchantLogic:DisenchantItem(item)
    ...
    if LibsDisenchantAssistDB.options.confirmDisenchant then
