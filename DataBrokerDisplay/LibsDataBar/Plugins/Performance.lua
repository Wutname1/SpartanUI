...
function PerformancePlugin:GetTooltip()
    ...
    if ldbMemory > 0 then
        tooltip = tooltip .. string.format("LibsDataBar: %.2f KB\n", ldbMemory)
    end
    ...
    return {
        ...
        args = {
            showFPS = {
                ...
                order = 10,
                get = function() return self:GetConfig("showFPS") end,
                set = function(_, value) self:SetConfig("showFPS", value) end,
            },
            showLatency = {
                type = "toggle",
                name = "Show Latency",
                ...
                order = 20,
                get = function() return self:GetConfig("showLatency") end,
                set = function(_, value) self:SetConfig("showLatency", value) end,
            },
            showMemory = {
                type = "toggle",
                name = "Show Memory",
                ...
                order = 30,
                get = function() return self:GetConfig("showMemory") end,
                set = function(_, value) self:SetConfig("showMemory", value) end,
            },
            memoryUnits = {
                type = "select",
                name = "Memory Units",
                ...
                get = function() return self:GetConfig("memoryUnits") end,
                set = function(_, value) self:SetConfig("memoryUnits", value) end,
            },
            colorByPerformance = {
                type = "toggle",
                ...
                order = 50,
                get = function() return self:GetConfig("colorByPerformance") end,
                set = function(_, value) self:SetConfig("colorByPerformance", value) end,
            },
        }
    }
end
